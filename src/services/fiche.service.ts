 ...
 */
export const createFiche = async (data: FicheServiceData): Promise<IFiche> => {
 ...
 */
export const getFicheByUserId = async (userId: Types.ObjectId): Promise<IFiche[]> => {
 ...
 */
export const getFicheById = async (id: Types.ObjectId): Promise<IFiche | null> => {
 ...
 */
export const updateFiche = async (id: Types.ObjectId, data: UpdateFicheDTO): Promise<IFiche | null> => {
 ...
 */
export const deleteFiche = async (id: Types.ObjectId): Promise<void> => {
 ...
 */
export const getFicheByTitle = async (title: string): Promise<IFiche[]> => {
